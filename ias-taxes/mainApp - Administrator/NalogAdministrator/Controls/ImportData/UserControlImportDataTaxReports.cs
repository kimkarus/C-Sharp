...
namespace NalogAdministrator.Controls
{
    public partial class UserControlImportDataReportDefaultTools : UserControl
    {
        ...
        private void btAdd_Click(object sender, EventArgs e)
        {
            ...
            cr.ImportData.Var.IsListOfTaxes = this.checkBoxListOfTaxes.Checked;
        ...
        private void checkAddByListOfSubjec()
        {
        ...
        private void checkCh1PATENT()
        {
            cr.ImportData.Var.Ch1PATENT = this.ch1Patent.Checked;
        }
        private void checkBoxIsImportOneList_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void txtChoceYearAfter_TextChanged(object sender, EventArgs e)
        {

        }

        private void checkBoxListOfTaxes_CheckedChanged(object sender, EventArgs e)
        {
